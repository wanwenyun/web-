import{_ as s,o as n,c as a,V as l}from"./chunks/framework.75331a37.js";const C=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"算法/数组/双指针/876.链表的中间结点.md","filePath":"算法/数组/双指针/876.链表的中间结点.md"}'),p={name:"算法/数组/双指针/876.链表的中间结点.md"},t=l(`<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/*</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;">// @lc code=end</span></span></code></pre></div>`,1),o=[t];function e(c,i,y,r,F,D){return n(),a("div",null,o)}const E=s(p,[["render",e]]);export{C as __pageData,E as default};
