import{_ as s,o as n,c as a,d as l}from"./app.8cb9dc40.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"算法/链表/双指针技巧 - 单链表/160.相交链表.md"}'),p={name:"算法/链表/双指针技巧 - 单链表/160.相交链表.md"},o=l(`<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;">/*</span></span>
